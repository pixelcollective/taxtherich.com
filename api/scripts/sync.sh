...
DEVSITE="https://api.taxtherich.valet"

STAGDIR="web@api.taxtherich.com:/srv/www/example/shared/uploads/"
STAGSITE="https://api.taxtherich.com"

PRODDIR="web@api.taxtherich.com:/srv/www/example/shared/uploads/"
PRODSITE="https://api.taxtherich.com"
